...
#define NO_ACCUMULATION 0x02000000 
...
int initLRADC0(){
	...
	imx233_wr(HW_LRADC_CTRL2_SET, LRADC0_DIVIDE_BY_2);
	//de accumulatie moet afgezet worden.
	imx233_wr(HW_LRADC_CH0_CLR,NO_ACCUMULATION | ZERO_SAMPLES);
}

int initLRADC1(){
	//geen divide by 2
	imx233_wr(HW_LRADC_CTRL2_CLR, LRADC1_DIVIDE_BY_2);
	//de accumulatie moet afgezet worden.
	imx233_wr(HW_LRADC_CH1_CLR,NO_ACCUMULATION | ZERO_SAMPLES);
}
